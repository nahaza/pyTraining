...
def change_v1_man_max_in_list(list_elem):
    mymin = min(list_elem)
    mymax = max(list_elem)
    index_mymin = list_elem.index(min(list_elem))
    index_mymax = list_elem.index(max(list_elem))
    list_elem[index_mymin] = mymax
    list_elem[index_mymax] = mymin
    print(mymin)
    print(mymax)
    print(list_elem)


def change_v2_man_max_in_list(list_elem):
    mymin = min(list_elem)
    mymax = max(list_elem)
