...
from ua.univer.lesson08.vehicle_task.coordinate import Point
from ua.univer.lesson08.vehicle_task.passenger import Passenger
from ua.univer.lesson08.vehicle_task.vehicle_ables import SwimAble


class Vehicle(metaclass=abc.ABCMeta):
    def __init__(self, point: Point, price, speed, year):
        self.point = point
        self.price = price
        self.speed = speed
        self.year = year
...
class PlanePassenger(Plane, Passenger):
    ...
    def show_image(self):
        print("PlanePassenger")


class PlaneCargo(Plane, Passenger):
